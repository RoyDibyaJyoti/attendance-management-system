...
public class FacultyController {
    ...
    public ResponseEntity<PagedResponse<FacultyResponse>> listFaculty(
        ...
        return ResponseEntity.ok(facultyService.listFaculty(page, boundedSize, includeInactive));
    }
    ...
    @Operation(summary = "Deactivate a faculty member")
    public ResponseEntity<FacultyResponse> deactivateFaculty(@PathVariable UUID id) {
        return ResponseEntity.ok(facultyService.setFacultyActiveStatus(id, false));
    }

    @PatchMapping("/{id}/reactivate")
    @Operation(summary = "Reactivate a faculty member")
    public ResponseEntity<FacultyResponse> reactivateFaculty(@PathVariable UUID id) {
        return ResponseEntity.ok(facultyService.setFacultyActiveStatus(id, true));
    }
}
